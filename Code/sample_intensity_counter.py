...
class SampleIntensityCounter(FileManager):
    ...
    def make_segmentation_folders(self):
        ...
        for channel in self.channels_to_use:
            segmentation_folders.append(self.make_new_folder(self.folder, f'segmentation_{channel}/'))
    ...
    def add_to_results(self, file, name, valid_labels, count):
        ...
        self.results[file]['count_' + name] = count
...
# FOLDER = 'C:/Users/Paridaen/Documents/Nynke/data/20220422_teton_data_yuanyuan/4dpf/'
...
# intensity_counter = SampleIntensityCounter(FOLDER, NAME_RESULTS_FILE, NAME_LABELMAP_FOLDER, CHANNELS_TO_USE, MODE, CHANNEL_THRESHOLDS_MEAN, CHANNEL_THRESHOLDS_MAX, PREPROCESSED)
# intensity_counter.make_summary()
